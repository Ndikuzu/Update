    ...
    async handler(chatUpdate) {
       ...
       const _uptime = process.uptime() * 1000
        ...
        try {
            ...
            const isjadibot = db.data.users[m.sender].jadibot
        ...
        //    const groupMetadata = (m.isGroup ? (conn.chats[m.chat].metadata || await conn.groupMetadata(m.chat)): {}) || {}
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (plugin.jadibot && !isjadibot) { // jadibot
                        fail('jadibot', m, this)
                        continue
                    }
...
global.dfail = (type, m, conn) => {
    ...
    nd: `𝙐𝙥𝙨𝙞𝙚! 𝘼𝙠𝙨𝙚𝙨 𝙞𝙣𝙞 𝙘𝙪𝙢𝙖 𝙗𝙪𝙖𝙩 𝙉𝙙𝙞𝙠𝙯 𝙮𝙖𝙣𝙜 𝙨𝙥𝙚𝙨𝙞𝙖𝙡 𝙗𝙖𝙣𝙜𝙚𝙩~ 𝙈𝙖𝙖𝙛 𝙮𝙖, 𝙘𝙪𝙢𝙖 𝙉𝙙𝙞𝙠𝙯 𝙮𝙖𝙣𝙜 𝙗𝙤𝙡𝙚𝙝 𝙢𝙖𝙨𝙪𝙠 𝙨𝙞𝙣𝙞! 😚✨`,
        rowner: `𝑶𝒐𝒑𝒔𝒊𝒆! 𝑨𝒌𝒔𝒆𝒔 𝒊𝒏𝒊 𝒌𝒉𝒖𝒔𝒖𝒔 𝒖𝒏𝒕𝒖𝒌 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝒃𝒐𝒕 𝒚𝒂𝒏𝒈 𝒌𝒆𝒓𝒆𝒏 𝒃𝒂𝒏𝒈𝒆𝒕~! 𝑴𝒂𝒂𝒇 𝒚𝒂, 𝒄𝒖𝒎𝒂 𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝒚𝒂𝒏𝒈 𝒃𝒊𝒔𝒂 𝒑𝒂𝒌𝒆𝒌 𝒊𝒏𝒊! 🤖💻`,
    owner: `𝗢𝗼𝗽𝘀𝗶𝗲 𝗱𝗼𝗼𝗽𝘀𝗶𝗲! 𝗔𝗸𝘀𝗲𝘀 𝗶𝗻𝗶 𝗰𝘂𝗺𝗮 𝗯𝘂𝗮𝘁 𝗼𝘄𝗻𝗲𝗿 𝘆𝗮𝗻𝗴 𝘀𝘂𝗽𝗲𝗿 𝗱𝘂𝗽𝗲𝗿 𝘀𝗽𝗲𝘀𝗶𝗮𝗹~! 𝗠𝗮𝗮𝗳 𝘆𝗮, 𝗵𝗮𝗻𝘆𝗮 𝗼𝘄𝗻𝗲𝗿 𝘆𝗮𝗻𝗴 𝗯𝗼𝗹𝗲𝗵 𝗽𝗮𝗸𝗲𝗸 𝗶𝗻𝗶! 😘🌟`,
    mods: `𝑶𝒐𝒑𝒔𝒊𝒆 𝒘𝒐𝒐𝒑𝒔𝒊𝒆! 𝑨𝒌𝒔𝒆𝒔 𝒊𝒏𝒊 𝒌𝒉𝒖𝒔𝒖𝒔 𝒃𝒖𝒂𝒕 𝒎𝒐𝒅𝒆𝒓𝒂𝒕𝒐𝒓 𝒚𝒂𝒏𝒈 𝒊𝒎𝒖𝒕-𝒊𝒎𝒖𝒕 𝒂𝒋𝒂~! 😘✨`,
    premium: `𝐀𝐤𝐬𝐞𝐬 𝐝𝐢𝐭𝐨𝐥𝐚𝐤! 𝐔𝐩𝐬, 𝐢𝐧𝐢 𝐚𝐫𝐞𝐚 𝐤𝐡𝐮𝐬𝐮𝐬 𝐮𝐧𝐭𝐮𝐤 𝐩𝐞𝐧𝐠𝐠𝐮𝐧𝐚 𝐩𝐫𝐞𝐦𝐢𝐮𝐦 𝐲𝐚𝐧𝐠 𝐢𝐬𝐭𝐢𝐦𝐞𝐰𝐚. 𝐊𝐚𝐥𝐚𝐮 𝐦𝐚𝐮 𝐢𝐤𝐮𝐭𝐚𝐧, 𝐣𝐚𝐧𝐠𝐚𝐧 𝐥𝐮𝐩𝐚 𝐮𝐩𝐠𝐫𝐚𝐝𝐞 𝐲𝐚𝐚! 🌟`,
        jadibot: `𝑶𝒐𝒑𝒔𝒊𝒆! 𝑨𝒌𝒔𝒆𝒔 𝒊𝒏𝒊 𝒄𝒖𝒎𝒂 𝒃𝒖𝒂𝒕 𝒚𝒂𝒏𝒈 𝒍𝒂𝒈𝒊 𝒋𝒂𝒅𝒊𝒃𝒐𝒕 𝒂𝒋𝒂~! 🤖✨\n\nKetik .b-tiketbot untuk mengakses fitur ini`,
        banned: '🚩 Perintah ini hanya untuk pengguna yang terbanned..',
        created: '𝑶𝒏𝒍𝒚 𝒐𝒘𝒏𝒆𝒓 𝒃𝒂𝒔𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 !!',
        group: `𝑶𝒐𝒑𝒔𝒊𝒆 𝒅𝒐𝒐𝒑𝒔𝒊𝒆! 𝑨𝒌𝒔𝒆𝒔 𝒊𝒏𝒊 𝒄𝒖𝒎𝒂 𝒃𝒖𝒂𝒕 𝒚𝒂𝒏𝒈 𝒂𝒅𝒂 𝒅𝒊 𝒅𝒂𝒍𝒂𝒎 𝒈𝒓𝒐𝒖𝒑 𝒄𝒉𝒂𝒕 𝒂𝒋𝒂~! 😊💬`,
    private: `𝐎𝐨𝐩𝐬𝐢𝐞 𝐰𝐨𝐨𝐩𝐬𝐢𝐞! 𝐀𝐤𝐬𝐞𝐬 𝐢𝐧𝐢 𝐜𝐮𝐦𝐚 𝐛𝐮𝐚𝐭 𝐝𝐢 𝐩𝐫𝐢𝐯𝐚𝐭𝐞 𝐜𝐡𝐚𝐭 𝐚𝐣𝐚~! 😚✨`,
    admin: `𝑶𝒐𝒑𝒔𝒊𝒆, 𝒂𝒌𝒔𝒆𝒔 𝒊𝒏𝒊 𝒄𝒖𝒎𝒂 𝒖𝒏𝒕𝒖𝒌 𝒂𝒅𝒎𝒊𝒏 𝒈𝒓𝒖𝒑 𝒂𝒋𝒂! 𝑲𝒂𝒍𝒂𝒖 𝒌𝒂𝒎𝒖 𝒂𝒅𝒎𝒊𝒏, 𝒚𝒖𝒌 𝒄𝒐𝒃𝒂 𝒍𝒂𝒈𝒊~ 😊🌸`,
    botAdmin: `𝑪𝒐𝒎𝒎𝒂𝒏𝒅 𝒊𝒏𝒊 𝒉𝒂𝒏𝒚𝒂 𝒃𝒊𝒔𝒂 𝒅𝒊 𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝒋𝒊𝒌𝒂 𝒃𝒐𝒕 𝒎𝒆𝒏𝒋𝒂𝒅𝒊 𝒂𝒅𝒎𝒊𝒏 𝒚𝒂𝒉 🌟`,
        unreg: `*「 🚩 𝐃𝐀𝐅𝐓𝐀𝐑 」*\n\n📝 𝑺𝒊𝒍𝒂𝒉𝒌𝒂𝒏 𝒅𝒂𝒇𝒕𝒂𝒓 𝒌𝒆 𝒅𝒂𝒕𝒂𝒃𝒂𝒔𝒆 𝒕𝒆𝒓𝒍𝒆𝒃𝒊𝒉 𝒅𝒂𝒉𝒖𝒍𝒖 𝒖𝒏𝒕𝒖𝒌 𝒎𝒆𝒏𝒈𝒈𝒖𝒏𝒂𝒌𝒂𝒏 𝒃𝒐𝒕 𝒊𝒏𝒊 𝒍𝒆𝒃𝒊𝒉 𝒍𝒂𝒏𝒋𝒖𝒕. 𝑮𝒖𝒏𝒂𝒌𝒂𝒏 𝒑𝒆𝒓𝒊𝒏𝒕𝒂𝒉 𝒃𝒆𝒓𝒊𝒌𝒖𝒕:\n\n👉 .𝒅𝒂𝒇𝒕𝒂𝒓 𝒏𝒂𝒎𝒂𝑨𝒏𝒅𝒂.𝒖𝒎𝒖𝒓\n👤 Contoh: .daftar IjulTaka.22\n\n`,
