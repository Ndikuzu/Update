...
${cmenuf}
       ...
       let rasat = await fetch(`${neNdikz}api/youtube?url=${videoUrl}&type=video&quality=720p&apikey=${neoapi}`)

        // Membuat dokumen video
        let vas = await rasat.json()
  let v = vas.data
  
  let cap = `${htki} PLAY VIDEO ${htka}
  
▢ *🙆🏻 TITLE* : ${vas.title}
▢ *🙆🏻 DURATION* : ${vas.duration}
▢ *🙆🏻 Channel* : ${vas.channel}
▢ *🙆🏻 VIEW* : ${vas.views}
${dmenuf}
`
